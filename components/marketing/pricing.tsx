...
const tiers = [
  {
    ...
    priceMonthly: "£0",
    description:
      "The essentials for getting started, collecting feedback and enhancing your product.",
    features: [
      "1 User",
...
export default function Pricing() {
  return (
    <div className="overflow-hidden isolate bg-zinc-950" id="pricing">
      <div className="px-6 pt-24 mx-auto text-center max-w-7xl pb-96 sm:pt-32 lg:px-8">
        ...
        <div className="relative mt-6">
          <p className="max-w-2xl mx-auto text-lg leading-7 text-white/60">
              ...
              {tiers.map((tier) => (
                ...
                >
                  <div>
                    ...
                    <ul
                      role="list"
                      className="mt-10 space-y-4 text-sm leading-7"
                    >
                      {tier.features.map((feature) => (
                        <li key={feature} className="flex items-center gap-x-3">
                          <Check
                            className="w-5 h-5 stroke-2 stroke-mint fill-none"
                            aria-hidden="true"
                          />
                          {feature}
                        </li>
